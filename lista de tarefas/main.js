function getProjects() {
    const urlGitHub = "https://api.github.com/users/eduveigaa/repos"; // Inserir o nome de usuário do seu github
  ...
  function showProjects(data) {
    ...
    data.forEach((repo) => {
      ...
      a.href = repo["https://api.github.com/users/eduveigaa/repos"]; // Link para o repositório no GitHub
      a.target = "_blank";
